...
import Projects.Splitwise.ExpenseManager.ExpenseManager;
import Projects.Splitwise.SplitFactoryPattern.SplitFactory;
import Projects.Splitwise.SplitStrategyPattern.Split;
import Projects.Splitwise.UtilityClasses.BalanceSheet;
import Projects.Splitwise.UtilityClasses.Expense;
import Projects.Splitwise.UtilityClasses.Transaction;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Display suboptimal minimum settlements
        System.out.println("n========== SUB OPTIMAL SETTLEMENTS ==========");
        ...
        for (Transaction transaction: settlements) {
            System.out.println(transaction.getFrom().getName() + " pays " + transaction.getTo().getName()
